sink('C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_Rlog.txt')

library(rgl)
library(vegan)
library(labdsv)

solutions<-read.table('C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_solutionsmatrix.csv',header=TRUE, row.name=1, sep=',')
soldist<-vegdist(solutions,distance='bray')
sol.mds<-nmds(soldist,2)

bmp(file='C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_2d_plot.bmp',width=1346,height=748,pointsize=10)
...
bmp(file='C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_dendogram.bmp',width=1346,height=748,pointsize=10)
...
write('solution,cluster',file='C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_cluster.csv')

for(i in 1:10)
{
   cat(i,file='C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_cluster.csv',append=TRUE)
   cat(',',file='C:\\Users\\nurac\\OneDrive\\Escritorio\\Scenario 4\\output\\output_cluster.csv',append=TRUE)
